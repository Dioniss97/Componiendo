...
class Table extends HTMLElement {
    ...
    render() {
        ...
        // bucle que para cada button de tableStructure.buttons crea un th con el nombre del botón
                ...
                buttons.forEach((key) => {
                    ...
                    if (tableStructure.buttons[key] === true) {
                        ...
                        if (key === 'edit') {
                            ...
                            dispatchEvent(new CustomEvent('edit', {detail: {id: register.id, load: true}}));
                            ...
                            dispatchEvent(new CustomEvent('remove', {detail: {id: register.id, load: false}}));
